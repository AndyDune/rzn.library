...
$arModuleVersion = array(
    "VERSION" => "2.26.0",
    "VERSION_DATE" => "2017-01-30 13:00:00"
);
/**
 ...
 *
 * 2.26.0
 * Разделяемые параметры водопада меняются по обычным правилам в дальнейшей работе водопада.
 *
 * 2.25.9
 * Перед инъекцией сервиса происходит проверка на его существованиие. Это важно при отключении модулей.
 *
 * 2.25.8
 * Не подключается конфиг из модуля который не установлен в битриксе.
 *
 * 2.25.7
 * Дроп водопада curl может слать заголовки.
 *
 * 2.25.6
 * Повышена стабильность контейнера массива. Создан тест.
 *
 * 2.25.5
 * Слушатели событий bitrix_events могут менять параметры, которые битрикс передает по ссылке.
 *
 * 2.25.4
 * Добавил в заголовок User-Agent для дропа водопада
 *
 * 2.25.3
 * Разделяемые парамтеры для водопада теперь работают и для первого шага.
 *
 * 2.25.2
